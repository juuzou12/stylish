...
class FirebaseExtension extends StatefulWidget {
  final String title,filter,category;
  final ThemeChanger themeChanger;

  const FirebaseExtension({Key key, this.title, this.filter, this.category, this.themeChanger}) : super(key: key);
...
class _RecentPageState extends State<FirebaseExtension> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.themeChanger==ThemeData.dark()?Container(
      child: Column(
        children: [
          Padding(
